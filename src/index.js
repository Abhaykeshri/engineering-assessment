...
// Root route
app.get("/", (req, res) => {
  res.send("Server is running. Use /balanceApiTest to fetch data.");
});

// API endpoint to fetch ETH balance
app.get("/balanceApiTest", async (req, res) => {
  try {
    ...
    console.log("Fetched ETH Balance:", ethBalance);
